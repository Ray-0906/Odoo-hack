...
const SoloLoading = ({ loading, message }) => {
      ...
      <div className="bg-white rounded-2xl p-8 shadow-2xl border border-white/20">
        <div className="flex flex-col items-center space-y-4">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-12 h-12 border-4 border-transparent border-t-indigo-400 rounded-full animate-spin animate-reverse"></div>
          </div>
      ...
      {!loading && (
        <div className={`w-full max-w-md transition-all duration-1000 ${
          ...
          >
            ...
            {/* Demo Credentials */}
            <div className="p-4 bg-blue-50/50 backdrop-blur-sm rounded-2xl border border-blue-200/30">
